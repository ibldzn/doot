...
function M.highlights(pal)
  ...
  return {
    ...
    -- navic
    NavicIconsFile          = { fg=pal.fg      },
    NavicIconsModule        = { fg=pal.dcyan   },
    NavicIconsNamespace     = { fg=pal.fg      },
    NavicIconsPackage       = { fg=pal.fg      },
    NavicIconsClass         = { fg=pal.dcyan   },
    NavicIconsMethod        = { fg=pal.dblue   },
    NavicIconsProperty      = { fg=pal.dpurple },
    NavicIconsField         = { fg=pal.dcyan   },
    NavicIconsConstructor   = { fg=pal.dcyan   },
    NavicIconsEnum          = { fg=pal.dcyan   },
    NavicIconsInterface     = { fg=pal.dcyan   },
    NavicIconsFunction      = { fg=pal.dblue   },
    NavicIconsVariable      = { fg=pal.dpurple },
    NavicIconsConstant      = { fg=pal.dyellow },
    NavicIconsString        = { fg=pal.dgreen  },
    NavicIconsNumber        = { fg=pal.dyellow },
    NavicIconsBoolean       = { fg=pal.dyellow },
    NavicIconsArray         = { fg=pal.dcyan   },
    NavicIconsObject        = { fg=pal.dcyan   },
    NavicIconsKey           = { fg=pal.dpurple },
    NavicIconsNull          = { fg=pal.dyellow },
    NavicIconsEnumMember    = { fg=pal.dyellow },
    NavicIconsStruct        = { fg=pal.dcyan   },
    NavicIconsEvent         = { fg=pal.lyellow },
    NavicIconsOperator      = { fg=pal.fg      },
    NavicIconsTypeParameter = { fg=pal.dpurple },
    NavicText               = { fg=pal.text2   },
    NavicSeparator          = { fg=pal.text2   },
  }
  -- stylua: ignore end
end
