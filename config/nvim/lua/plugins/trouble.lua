...
local keys = {
	...
	{ "gr", "<cmd>Trouble lsp_references<CR>", desc = "Go LSP references" },
	{ "gi", "<cmd>Trouble lsp_implementations<CR>", desc = "Go LSP implementations" },
	{ "gy", "<cmd>Trouble lsp_type_defintions<CR>", desc = "Go LSP type defintions" },
